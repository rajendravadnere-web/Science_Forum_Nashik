...
<p> <p>
   You may find the YouTube channel for the Science Forum Nashik <a href="https://www.youtube.com/@scienceforumnashik3344/featured" target="_blank"> here. </a>
<p>
...
<!-- ===== DEED PDF ===== -->
You may see the full text of the AOP Deed (25 Sep 2025)   <a href="https://github.com/rajendravadnere-web/Scienceforum/blob/main/AOP_deed_24SEPT2025.pdf" target="_blank"> here. </a>

<!-- ===== OBJECTIVES (Section 2) ===== -->
<h2>Our Objectives</h2>
As mentioned in the Section 2 of the AOP Deed:
<p>

The AOP shall strive to realize the following:
<p>
...
All the decisions taken by the AOP as discussed and finalised in the various meetings and interactions are as follows:
<!-- Example: --><p>
<a href="decisions/october-28-2025.pdf" target="https://drive.google.com/file/d/1ZK5zA2C1DYTtx6EJECP_LD-GsDQdhCgZ/view?usp=sharing">
   October 28, 2025 Meeting.</p>
</a>

<!-- ===== FUTURE EVENTS ===== -->
<h2>Upcoming Events</h2>
<ul>
  Video Clip Competitions based on Activity-based Learning on Science and Maths subjects for Students 2026
   <p>
      Under Development
   </p>
  <!-- Example: <li>15 Dec 2025: Hands-on Science Teacher Workshop</li> -->
</ul>

<!-- ===== PAST EVENTS ===== -->
<h2>Past Events</h2>
<ul>
  <a href="decisions/october-28-2025.pdf" target="[s:/http/drive.google.com/file/d/1ZK5zA2C1DYTtx6EJECP_LD-GsDQdhCgZ/view?usp=sharing](https://www.youtube.com/playlist?list=PLP7UR0ZnLgb6VAlMbeMMR2cTvFTpTNeAz)">
   Teachers Worskshop on Activity Based Learning, July,4 and 5, 2025.</p>
</a>
  <!-- Example: <li>28 Oct 2025: Approved Forms 9.1.A–C</li> -->
</ul>
